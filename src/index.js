...
export default class FadeInSwitch extends Switch {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        setTimeout(() => Animated.spring(this.state.animate, {toValue: 1}).start(), 450);
    }

    componentWillReceiveProps() {
        setTimeout(() => Animated.spring(this.state.animate, {toValue: 1}).start(), 450);
        Animated
            .spring(this.state.animate, {toValue: 0.5})
            .start();
    }
    render() {
        const style = {
